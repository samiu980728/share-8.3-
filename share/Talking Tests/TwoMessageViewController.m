...
@interface TwoMessageViewController ()<UITableViewDataSource,UITableViewDelegate,UITextFieldDelegate>
...
@implementation TwoMessageViewController
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    self.navigationItem.title = @"与share小兰的对话";
